...
public class CarrGridServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		String output = req.getSession().getServletContext().getRealPath("/") + "/carrgridout" + year+"_"+kbn;
		...
		try {
			...
			job.setJarByClass(CarrGridServlet.class); // getClass() : Object 클래스의 멤버 (해당 객체의 클래스 정보를 리턴)
		...
		RequestDispatcher dispatcher = req.getRequestDispatcher("/dataexpo/dataexpo8.jsp");
