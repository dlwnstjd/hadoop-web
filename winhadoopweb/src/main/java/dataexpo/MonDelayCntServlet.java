...
//@WebServlet("/MonServlet") // 해당 url 요청이 들어오는 경우 MonDelayCntServlet 서블릿을 실행
public class MonDelayCntServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(kbn.equals("a")) job.setMapperClass(ArrivalDelayMapper.class);
			else job.setMapperClass(DepartureDelayMapper.class);
